...
export declare function getHoldingAggregatedPurchases(holding: IHolding | IPopulatedHolding): ITransaction[];
export declare function getHoldingAggregatedSales(holding: IHolding | IPopulatedHolding): ITransaction[];
