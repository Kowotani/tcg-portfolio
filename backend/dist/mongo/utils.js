...
exports.getIMHoldingsFromIHoldings = exports.isValidTransactions = exports.isValidHoldings = void 0;
...
*/
function isValidHoldings(holdings) {
...
exports.isValidHoldings = isValidHoldings;
/*
DESC
...
function isValidTransactions(transactions) {
    // net quantity
    return (0, common_1.getQuantity)(transactions) >= 0;
}
exports.isValidTransactions = isValidTransactions;
// ==========
// converters
// ==========
/*
