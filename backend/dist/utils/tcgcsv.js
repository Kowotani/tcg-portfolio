...
exports.SORCERY_BOOSTER_BOX_NAME = exports.PKM_UPC_MSRP = exports.PKM_ETB_MSRP = exports.PKM_BOOSTER_BUNDLE_MSRP = exports.PKM_BOOSTER_BOX_MSRP = exports.PKM_UPC_NAME = exports.PKM_PC_ETB_SET_NAME = exports.PKM_PC_ETB_FORMAT = exports.PKM_ETB_TYPE_NAME = exports.PKM_ETB_SET_NAME = exports.PKM_ETB_FORMAT = exports.PKM_BOOSTER_BUNDLE_NAME = exports.PKM_BOOSTER_BOX_NAME = exports.PKM_CODE_CARD_FORMAT = exports.METAZOO_FIRST_EDITION_BOOSTER_BOX_MSRP = exports.METAZOO_FIRST_EDITION_BOOSTER_BOX_NAME = exports.MTG_SL_NON_FOIL_MSRP = exports.MTG_SL_FOIL_MSRP = exports.MTG_SL_EDH_DECK_MSRP = exports.MTG_SET_BOOSTER_BOX_MSRP = exports.MTG_PLAY_BOOSTER_BOX_MSRP = exports.MTG_DRAFT_BOOSTER_BOX_MSRP = exports.MTG_COLLECTOR_BOOSTER_BOX_MSRP = exports.MTG_BUNDLE_MSRP = exports.MTG_SL_TEXTURED_FOIL_NAME = exports.MTG_SL_NON_FOIL_NAME = exports.MTG_SL_GILDED_FOIL_NAME = exports.MTG_SL_GALAXY_FOIL_NAME = exports.MTG_SL_FOIL_NAME = exports.MTG_SL_FOIL_ETCHED_NAME = exports.MTG_SL_EDH_DECK_NAME = exports.MTG_SL_BUNDLE_FORMAT = exports.MTG_SL_FORMAT = exports.MTG_JUMPSTART_BOOSTER_BOX_FORMAT = exports.MTG_EDH_DECK_SET_NAME = exports.MTG_SET_BOOSTER_BOX_NAME = exports.MTG_PLAY_BOOSTER_BOX_NAME = exports.MTG_DRAFT_BOOSTER_BOX_NAME = exports.MTG_COLLECTOR_BOOSTER_BOX_NAME = exports.MTG_BUNDLE_NAME = exports.LORCANA_ILLUMINEERS_TROVE_MSRP = exports.LORCANA_BOOSTER_BOX_MSRP = exports.LORCANA_ILLUMINEERS_TROVE_NAME = exports.LORCANA_BOOSTER_BOX_NAME = exports.FAB_UNLIMITED_EDITION_BOOSTER_BOX_MSRP = exports.FAB_FIRST_EDITION_BOOSTER_BOX_MSRP = exports.FAB_BOOSTER_BOX_MSRP = exports.FAB_UNLIMITED_EDITION_BOOSTER_BOX_NAME = exports.FAB_FIRST_EDITION_BOOSTER_BOX_NAME = exports.FAB_BOOSTER_BOX_NAME = void 0;
exports.TCCATEGORYID_TO_TCG_MAP = exports.TCCATEGORYNAME_TO_TCG_MAP = exports.TCG_TO_TCCATEGORY = exports.SORCERY_BOOSTER_BOX_MSRP = void 0;
...
exports.MTG_COLLECTOR_BOOSTER_BOX_NAME = /^.*(?= - Collector Booster (Box|Display)$)/g;
...
exports.MTG_SET_BOOSTER_BOX_NAME = /^.*(?= - Set Booster (Box|Display)$)/g;
exports.MTG_EDH_DECK_SET_NAME = /^.*?(?=[ -]* Commander Deck(s? \[Set of \d\]| Case| Display))/g;
exports.MTG_JUMPSTART_BOOSTER_BOX_FORMAT = /Jumpstart Booster (Box|Display)$/;
exports.MTG_SL_FORMAT = /^Secret Lair/;
exports.MTG_SL_BUNDLE_FORMAT = /^Secret Lair.*Bundle$/;
...
// -------
// -- regex
exports.PKM_CODE_CARD_FORMAT = /^Code Card/;
exports.PKM_BOOSTER_BOX_NAME = /.*(?= Booster Box$)/g;
exports.PKM_BOOSTER_BUNDLE_NAME = /.*(?= Booster Bundle$)/g;
exports.PKM_ETB_FORMAT = /Elite Trainer Box($| \[(?!Set of).*\])/;
exports.PKM_ETB_SET_NAME = /.*(?= Elite Trainer Box($| \[(?!Set of).*\]))/g;
exports.PKM_ETB_TYPE_NAME = /(?<=\[).*(?=\]$)/g;
exports.PKM_PC_ETB_FORMAT = /Pokemon Center Elite Trainer Box($| \[(?!Set of).*\])/;
exports.PKM_PC_ETB_SET_NAME = /.*(?= Pokemon Center Elite Trainer Box($| \[(?!Set of).*\]))/g;
